...
class ComponentGrammarDefinition extends GrammarDefinition with TokenMixin {
  @override
...
//      ref(varToken) |
  ...
  Parser lambdaToken() =>
      ref(token, DOLLAR) & characterPrimitive().star() & ref(token, DOLLAR);
  ...
  //Parser varToken() => ref(token, DOLLAR) & ref(variableName);
